...
- Admin-mobile capabilities beyond the first scaffold: real WebSocket transport, real backend wiring for the current `/api/v1/mobile` BFF client, production server-backed pagination/search data flows, and full second-stage pages for users, modules, assets, releases, logs, and approvals.
